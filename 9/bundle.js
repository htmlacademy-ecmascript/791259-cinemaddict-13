...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: SortType, UserAction, UpdateType, FilterType */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mock_film_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mock/film.js */ "./src/mock/film.js");
/* harmony import */ var _presenter_site_presenter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/site-presenter.js */ "./src/presenter/site-presenter.js");
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/films.js */ "./src/model/films.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
...
const films = new Array(POSTS_COUNT).fill().map(() => Object(_mock_film_js__WEBPACK_IMPORTED_MODULE_0__["generateFilm"])());
const filmsModel = new _model_films_js__WEBPACK_IMPORTED_MODULE_2__["FilmsModel"]();
filmsModel.setFilms(films);

const filterModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_3__["FilterModel"]();
const sitePresenter = new _presenter_site_presenter_js__WEBPACK_IMPORTED_MODULE_1__["SitePresenter"](body, filmsModel, filterModel);
...
class CommentsModel extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["Observer"] {
  ...
  addComment(userAction, text, emotion) {
    ...
    const newComment = {
      ...
      author: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["generateRandomItem"])([`Tim Macoveev`, `John Doe`, `Andre Right`, `Greg Malkovich`]),
      text: this._commentText,
      emotion: this._commentEmotion,
      date: dayjs__WEBPACK_IMPORTED_MODULE_2___default()().format(`DD/MM/YYYY HH:MM`),
    };
...
class FilterModel extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["Observer"] {
  constructor() {
    super();
...
/* harmony import */ var _model_comments_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../model/comments.js */ "./src/model/comments.js");
...
const mockComments = new Array(5).fill().map((item, index) => Object(_mock_comment_js__WEBPACK_IMPORTED_MODULE_5__["generateComment"])(index));
...
class FilmPresenter {
  constructor(bodyContainer, filmListContainer, changeData, changeMode, filterModel) {
    ...
    this._commentsModel = new _model_comments_js__WEBPACK_IMPORTED_MODULE_6__["CommentsModel"]();
  ...
  _handleWatchListClick(event) {
    ...
    if (event.target.classList.contains(`film-card__controls-item--add-to-watchlist`) || event.target.classList.contains(`film-details__control-label--watchlist`)) {
      this._changeData(
          _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].UPDATE_FILM,
          activeFilter === `all` ? _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].PATCH : _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].MINOR,
          Object.assign({},
              this._film, {
  ...
  _handleFormSubmit(event) {
    ...
    this._commentsModel.addComment(_const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].ADD_COMMENT, this._commentText, this._commentEmotion);
  }
  ...
  _handleReturnToFilm() {
    ...
    this._changeData(
        _const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].UPDATE_FILM,
        _const_js__WEBPACK_IMPORTED_MODULE_7__["UpdateType"].PATCH,
        Object.assign({},
            this._film, {
  ...
  _handleDeleteCommentClick(event) {
    if (event.target.tagName === `BUTTON`) {
      ...
      this._commentsModel.deleteComment(_const_js__WEBPACK_IMPORTED_MODULE_7__["UserAction"].DELETE_COMMENT, deleteCommentId);
    }
  }
...
/*!*********************************!*\
  !*** ./src/presenter/filter.js ***!
  \*********************************/
/*! exports provided: FilterPresenter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilterPresenter", function() { return FilterPresenter; });
...
class FilterPresenter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filter_js__WEBPACK_IMPORTED_MODULE_0__["FilterView"](filters, this._currentFilter);
    this._filterComponent.setFilterTypeChangeHandler(this._handleFilterTypeChange);

    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent, `afterbegin`);
      return;
    }
  ...
  _getFilters() {
    ...
    return [{
      ...
      name: `All Movies`,
      count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL](films).length
    },
    {
...
/* harmony import */ var _view_films_container_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/films-container.js */ "./src/view/films-container.js");
/* harmony import */ var _film_presenter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./film-presenter.js */ "./src/presenter/film-presenter.js");
/* harmony import */ var _view_button_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/button.js */ "./src/view/button.js");
...
/* harmony import */ var _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/films-list-container.js */ "./src/view/films-list-container.js");
/* harmony import */ var _view_no_films_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../view/no-films.js */ "./src/view/no-films.js");
...
/* harmony import */ var _utils_filter_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utils/filter.js */ "./src/utils/filter.js");
/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./filter.js */ "./src/presenter/filter.js");
...
class SitePresenter {
  constructor(bodyContainer, filmsModel, filterModel) {
    ...
    this._filterPresenter = new _filter_js__WEBPACK_IMPORTED_MODULE_15__["FilterPresenter"](this._mainComponent, this._filterModel, this._filmsModel);
    ...
    this._filmsContainerComponent = new _view_films_container_js__WEBPACK_IMPORTED_MODULE_5__["FilmsContainerView"]();
    this._noFilmsComponent = new _view_no_films_js__WEBPACK_IMPORTED_MODULE_10__["NoFilmsView"]();

    this._filmsListContainer = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_9__["FilmListContainerView"]().getElement().querySelector(`.films-list__container`);
  ...
  init() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._bodyContainer, this._headerComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._headerComponent, this._userComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._bodyContainer, this._mainComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._mainComponent, this._filmsContainerComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._bodyContainer, this._footerComponent);
  ...
  _getFilms() {
    ...
    const films = this._filmsModel.getFilms();
    const filtredFilms = _utils_filter_js__WEBPACK_IMPORTED_MODULE_14__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_12__["SortType"].DATE:
        return filtredFilms.slice().sort((filmA, filmB) => dayjs__WEBPACK_IMPORTED_MODULE_13___default()(filmB.productionDate).format(`YYYY`) - dayjs__WEBPACK_IMPORTED_MODULE_13___default()(filmA.productionDate).format(`YYYY`));
  ...
  _handleViewAction(actionType, updateType, update) {
    if (actionType !== _const_js__WEBPACK_IMPORTED_MODULE_12__["UserAction"].UPDATE_FILM) {
      return;
    }
  ...
  _renderFilm(filmListContainer, film) {
    const filmPresenter = new _film_presenter_js__WEBPACK_IMPORTED_MODULE_6__["FilmPresenter"](this._bodyContainer, filmListContainer, this._handleViewAction, this._handleModeChange, this._filterModel);
  ...
  _clearBoard({resetRenderedFilmCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["remove"])(this._sortComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["remove"])(this._noFilmsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["remove"])(this._footerStatsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["remove"])(this._loadMoreButtonComponent);
  ...
  _renderLoadMoreButton() {
    ...
    this._loadMoreButtonComponent = new _view_button_js__WEBPACK_IMPORTED_MODULE_7__["LoadMoreButtonView"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsListContainer, this._loadMoreButtonComponent, `afterend`);
    this._loadMoreButtonComponent.setClickHandler(this._handleLoadMoreButtonClick);
  }

  _renderNoFilms() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsContainerComponent, this._noFilmsComponent);
  }

  _renderFooterStats() {
    const filmCount = this._getFilms().length;
    this._footerStatsComponent = new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_8__["FooterStatsView"](filmCount);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._footerComponent, this._footerStatsComponent);
  }
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sort_js__WEBPACK_IMPORTED_MODULE_4__["SortView"](this._currentSortType);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._mainComponent.getElement().firstChild, this._sortComponent, `afterend`);
  ...
  _renderBoard() {
    ...
    this._renderSort();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_11__["render"])(this._filmsContainerComponent, this._filmsListContainer);
...
const filter = {
  ...
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (films) => films.filter((item) => item.isAddedtoWatchList),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (films) => films.filter((item) => item.isWatched),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (films) => films.filter((item) => item.isFavorite),
};
...
const createFilmCommentsSection = (comments) => {
  const createFilmComment = (comment) => {
    ...
    return `<li data-id="${comment.id}" class="film-details__comment">
      ...
      <div>
        <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(comment.text)}</p>
