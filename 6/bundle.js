...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(header, new _view_user_js__WEBPACK_IMPORTED_MODULE_0__["UserView"]().getElement());
Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(main, new _view_filter_js__WEBPACK_IMPORTED_MODULE_1__["FilterView"](filters).getElement());
Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(main, new _view_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortView"]().getElement());
Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(main, postsContainerComponent.getElement());
Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent.getElement(), new _view_posts_list_container_js__WEBPACK_IMPORTED_MODULE_8__["PostListContainerView"](``,`visually-hidden`, 'All movies. Upcoming').getElement());
...
const renderPost = (postListContainer, post) => {
  ...
  const showPostDetails = (postListContainer = body) => {
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postListContainer, postDetailsComponent.getElement());

    for (let commentId of postDetailsComponent._post.comments) {
      for(let comment of comments) {
        if (commentId == comment.id) Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postDetailsComponent.getElement().querySelector(`.film-details__comments-list`), new _view_comment_js__WEBPACK_IMPORTED_MODULE_10__["CommentView"](comment).getElement());
      }
    }
  };
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postListContainer, postComponent.getElement());
};

if (posts.length <= 0) {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerMain, new _view_no_posts_js__WEBPACK_IMPORTED_MODULE_9__["NoPostsView"]().getElement());
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(footerStats, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_6__["FooterStatsView"](`0`).getElement());
} else {
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent.getElement(), new _view_posts_list_container_js__WEBPACK_IMPORTED_MODULE_8__["PostListContainerView"](`films-list--extra`, '', 'Top rated').getElement());
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent.getElement(), new _view_posts_list_container_js__WEBPACK_IMPORTED_MODULE_8__["PostListContainerView"](`films-list--extra`, '', 'Most commented').getElement());
  ...
  if (posts.length > POST_COUNT_PER_STEP) {
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent.getElement().firstElementChild, new _view_button_js__WEBPACK_IMPORTED_MODULE_5__["LoadMoreButtonView"]().getElement());
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_14__["render"])(footerStats, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_6__["FooterStatsView"](`130 291`).getElement());
};
