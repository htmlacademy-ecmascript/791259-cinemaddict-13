...
/* harmony import */ var _view_no_posts_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./view/no-posts.js */ "./src/view/no-posts.js");
/* harmony import */ var _view_comment_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./view/comment.js */ "./src/view/comment.js");
/* harmony import */ var _mock_filter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./mock/filter.js */ "./src/mock/filter.js");
/* harmony import */ var _mock_post_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mock/post.js */ "./src/mock/post.js");
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
...
const posts = new Array(POSTS_COUNT).fill().map(() => Object(_mock_post_js__WEBPACK_IMPORTED_MODULE_12__["generatePost"])());
const filters = Object(_mock_filter_js__WEBPACK_IMPORTED_MODULE_11__["generateFilter"])(posts);
const body = document.querySelector(`body`);
const header = body.querySelector(`header`);
const main = body.querySelector(`main`);
const footerStats = body.querySelector(`.footer__statistics`);
const comments = new Array(5).fill().map((item, index) => Object(_mock_comment_js__WEBPACK_IMPORTED_MODULE_13__["generateComment"])(index));
const postsContainerComponent = new _view_posts_container_js__WEBPACK_IMPORTED_MODULE_3__["PostsContainerView"]();

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(header, new _view_user_js__WEBPACK_IMPORTED_MODULE_0__["UserView"]());
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(main, new _view_filter_js__WEBPACK_IMPORTED_MODULE_1__["FilterView"](filters));
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(main, new _view_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortView"]());
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(main, postsContainerComponent);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent, new _view_posts_list_container_js__WEBPACK_IMPORTED_MODULE_8__["PostListContainerView"](``,`visually-hidden`, 'All movies. Upcoming'));
...
const renderPost = (postListContainer, post) => {
  ...
  const showPostDetails = (postListContainer = body) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postListContainer, postDetailsComponent);

    for (let commentId of postDetailsComponent._post.comments) {
      for(let comment of comments) {
        if (commentId == comment.id) Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postDetailsComponent.getElement().querySelector(`.film-details__comments-list`), new _view_comment_js__WEBPACK_IMPORTED_MODULE_10__["CommentView"](comment));
      }
    }
  };
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postListContainer, postComponent);
};

if (posts.length <= 0) {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerMain, new _view_no_posts_js__WEBPACK_IMPORTED_MODULE_9__["NoPostsView"]());
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(footerStats, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_6__["FooterStatsView"](`0`));
} else {
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent, new _view_posts_list_container_js__WEBPACK_IMPORTED_MODULE_8__["PostListContainerView"](`films-list--extra`, '', 'Top rated'));
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerComponent, new _view_posts_list_container_js__WEBPACK_IMPORTED_MODULE_8__["PostListContainerView"](`films-list--extra`, '', 'Most commented'));
  ...
  if (posts.length > POST_COUNT_PER_STEP) {
    ...
    const buttonComponent = new _view_button_js__WEBPACK_IMPORTED_MODULE_5__["LoadMoreButtonView"]();

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(postsContainerMain, buttonComponent, `afterend`);
  ...
  Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_14__["render"])(footerStats, new _view_footer_stats_js__WEBPACK_IMPORTED_MODULE_6__["FooterStatsView"](`130 291`));
};
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomIntInclusive, generateRandomItem, generateRandomDate, figureCorrectPluralForm, generateDescription */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
